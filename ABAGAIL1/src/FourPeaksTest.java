...
public class FourPeaksTest {
    ...
    public static void main(String[] args) {
        ...
        FixedIterationTrainerMod fit = new FixedIterationTrainerMod(rhc, 100000);
...
//        System.out.println("RHC: " + ef.value(rhc.getOptimal()) + " Time: " + trainingTime);
        ...
        fit = new FixedIterationTrainerMod(sa, 100000);
        start = System.nanoTime();
        fit.train(start);
        end = System.nanoTime();
        trainingTime = end - start;
        ...
        fit = new FixedIterationTrainerMod(ga, 100000);
        start = System.nanoTime();
        fit.train(start);
        end = System.nanoTime();
        trainingTime = end - start;
...
//        fit = new FixedIterationTrainerMod(mimic, 100000);
//        start = System.nanoTime();
//        fit.train(start);
//        end = System.nanoTime();
//        trainingTime = end - start;
